...
build {
  ...
  provisioner "ansible-local" {
    extra_arguments = ["--extra-vars", "\"username=${var.username} luks_passphrase=${var.luks_passphrase} password=${var.password} ssh_authorized_keys_bas64=${var.ssh_authorized_keys_bas64} random_seed=${var.random_seed_for_oath}\"", "-v"]
